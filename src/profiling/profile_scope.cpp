...
namespace gigno {
    ...
    void ProfileScope::EndFrame() {
        ...
        m_CurrentTotal -= m_Durations[m_CurrentDurationIndex];
        m_CurrentTotal += dur;
        ...
        if(m_CurrentTotal / PROFILE_SCOPE_RESOLUTION < m_CurrentCeilling * 0.35f) {
    ...
    void ProfileScope::DrawUI(int childDepth) {
        if(ImGui::TreeNode(m_Name.data())) {
            ...
            int avrg = (int)(m_CurrentTotal / PROFILE_SCOPE_RESOLUTION);
